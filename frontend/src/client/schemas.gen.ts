...
export const AddFoodCommandSchema = {
    ...
    properties: {
        $schema: {
            ...
            examples: [
                'https://example.com/schemas/AddFoodCommand.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const AddFoodResultSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/AddFoodResult.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const CreatePollCommandSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/CreatePollCommand.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
        ...
        strategy: {
            ...
            enum: [
                'ORDER_PERSONAL_CHOICE',
                'ORDER_CONSENSUS_ITEM'
            ],
            type: 'string'
        }
    },
...
export const CreatePollResponseSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/CreatePollResponse.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const GetCentrifugoJWTResponseSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/GetCentrifugoJWTResponse.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const GetOrderedItemsResponseSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/GetOrderedItemsResponse.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const GetShoppingOrderResponseSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/GetShoppingOrderResponse.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const Post_by_id_voteRequestSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/Post-by-id-voteRequest.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const Put_by_idRequestSchema = {
    ...
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/Put-by-idRequest.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const ResponseStruct___BodySchema = {
    additionalProperties: false,
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/ResponseStruct {}Body.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
...
export const SetAvatarRequestSchema = {
    additionalProperties: false,
    properties: {
        $schema: {
            description: 'A URL to the JSON Schema for this object.',
            examples: [
                'https://example.com/schemas/SetAvatarRequest.json'
            ],
            format: 'uri',
            readOnly: true,
            type: 'string'
        ...
        avatarUrl: {
            description: 'The URL of the newly set avatar',
            type: 'string'
        }
    },
    required: [
...
export const SetAvatarRequestWritableSchema = {
    additionalProperties: false,
    properties: {
        avatarUrl: {
            description: 'The URL of the newly set avatar',

...
type GetFoodEndpoint struct {
	getFoodsHandler GetFoodsQueryHandler
}

func NewGetFoodEndpoint(getFoodsHdl GetFoodsQueryHandler) *GetFoodEndpoint {
...
func (e *GetFoodEndpoint) GetFoods(ctx context.Context, req *struct{}) (*api.Response[GetFoodsResponse], error) {
	r, err := e.getFoodsHandler.Handle(ctx, GetFoodsQuery{})
	if err != nil {

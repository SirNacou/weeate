...
type UpdateFoodEndpoint struct {
	updateFoodHandler UpdateFoodCommandHandler
}

func NewUpdateFoodEndpoint(updateFoodHdl UpdateFoodCommandHandler) *UpdateFoodEndpoint {
...
func (e *UpdateFoodEndpoint) UpdateFood(ctx context.Context, req *struct {
	...
	err := e.updateFoodHandler.Handle(ctx, UpdateFoodCommand{
		ID:          req.ID,
		Name:        req.Body.Name,

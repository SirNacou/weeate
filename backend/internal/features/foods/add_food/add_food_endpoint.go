...
type AddFoodEndpoint struct {
	addFoodHandler AddFoodCommandHandler
}

func NewAddFoodEndpoint(addFoodHdl AddFoodCommandHandler) *AddFoodEndpoint {
...
func (e *AddFoodEndpoint) AddFood(ctx context.Context, req *struct{ Body AddFoodRequest }) (*api.Response[AddFoodResponse], error) {
	...
	result, err := e.addFoodHandler.Handle(ctx, AddFoodCommand{
		Name:        req.Body.Name,
